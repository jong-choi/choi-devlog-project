...
ARG OPENROUTER_SMALL_MODEL
ENV OPENROUTER_SMALL_MODEL=${OPENROUTER_SMALL_MODEL}
ARG OPENROUTER_MEDIUM_MODEL
ENV OPENROUTER_MEDIUM_MODEL=${OPENROUTER_MEDIUM_MODEL}
ARG VOYAGE_API_KEY
