...
export function RightPanelWrapper({ children }: { children: ReactNode }) {
  ...
  return (
    <aside
      className={cn(
        "transition-all duration-300 h-full hidden lg:flex flex-col flex-shrink-0 bg-slate-50 dark:bg-slate-900 xl:bg-glass-bg backdrop-blur-3xl border-l border-border shadow-sm ",
