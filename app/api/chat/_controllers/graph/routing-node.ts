...
응답 형태:
- Google 검색이 필요한 경우: {"type": "google", "query": "최적화된 검색어"} 또는 {"type": "google", "query": ["검색어1", "검색어2", "검색어 3"]}
- 이 기술블로그 내 검색이 필요한 경우 {"type": "blogSearch", "query": "키워드"} 또는 {"type": "blogSearch", "query": ["키워드1", "키워드2", "키워드3"]} (예시 : ["슈퍼베이스", "supabase"], [Next.js, 넥스트, next])
...
- 'blogSearch': '관련된 게시물', '연관된 게시물', '이 블로그에 있는 게시물'에 대한 검색이 필요한 질문
